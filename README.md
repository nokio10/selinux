...
Первый способ решения является приоритетным, так как устраняет причину неисправности, а 2 способ скорее является обходным путем, который предлагает утилита audit2why.
